...
class EventsController extends BaseController
{
    ...
    {
        $past_workshops = DB::table('workshops')->whereDate('start', '<=', now())->pluck('event_id')->toArray();
        $future_workshops = DB::table('workshops')->whereDate('start', '>', now())->whereNotIn('event_id', $past_workshops)->pluck('event_id')->toArray();
        
        $events = Event::all()->whereIn('id',  $future_workshops);
